...
/****************************************************************/
#ifndef PFFRACBULKRATEPLASTICFACTOR_H
#define PFFRACBULKRATEPLASTICFACTOR_H
/**
...
class PFFracBulkRatePlasticFactor;

template<>
InputParameters validParams<PFFracBulkRatePlasticFactor>();

class PFFracBulkRatePlasticFactor : public KernelValue
{
public:

  PFFracBulkRatePlasticFactor(const InputParameters & parameters);
...
protected:
  ...
  Real _Wc;
  /// pre-factor of the plastic contribution to damage
  Real _plastic_factor;

 private:

};
#endif //PFFRACBULKRATEPLASTICFACTOR_H
