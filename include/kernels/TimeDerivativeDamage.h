...
/****************************************************************/
#ifndef TIMEDERIVATIVEDAMAGE_H
#define TIMEDERIVATIVEDAMAGE_H

#include "KernelValue.h"
#include "RankTwoTensor.h"

// Forward Declarations
class TimeDerivativeDamage;

template <>
InputParameters validParams<TimeDerivativeDamage>();
 ...
 */
class TimeDerivativeDamage : public KernelValue
{
public:
  TimeDerivativeDamage(const InputParameters & parameters);
