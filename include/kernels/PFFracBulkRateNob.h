...
/****************************************************************/
#ifndef PFFRACBULKRATENOB_H
#define PFFRACBULKRATENOB_H

#include "KernelValue.h"
#include "RankTwoTensor.h"

// Forward Declarations
class PFFracBulkRateNob;

template <>
InputParameters validParams<PFFracBulkRateNob>();
 ...
 */
class PFFracBulkRateNob : public KernelValue
{
public:
  PFFracBulkRateNob(const InputParameters & parameters);
