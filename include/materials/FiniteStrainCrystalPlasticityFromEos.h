...
/****************************************************************/
#ifndef FINITESTRAINCRYSTALPLASTICITYFROMEOS_H
#define FINITESTRAINCRYSTALPLASTICITYFROMEOS_H
 ...
 */
class FiniteStrainCrystalPlasticityFromEos;

template <>
InputParameters validParams<FiniteStrainCrystalPlasticityFromEos>();

class FiniteStrainCrystalPlasticityFromEos : public ComputeStressEosBase
{
public:
  FiniteStrainCrystalPlasticityFromEos(const InputParameters & parameters);
...
#endif // FINITESTRAINCRYSTALPLASTICITYFROMEOS_H
