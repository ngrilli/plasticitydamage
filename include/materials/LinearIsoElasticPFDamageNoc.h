...
/****************************************************************/
#ifndef LINEARISOELASTICPFDAMAGENOC_H
#define LINEARISOELASTICPFDAMAGENOC_H
 ...
 */
class LinearIsoElasticPFDamageNoc : public ComputeStressBase
{
public:
  LinearIsoElasticPFDamageNoc(const InputParameters & parameters);
...
#endif // LINEARISOELASTICPFDAMAGENOC_H
