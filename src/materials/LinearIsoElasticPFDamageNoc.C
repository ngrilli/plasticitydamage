...
template <>
InputParameters
validParams<LinearIsoElasticPFDamageNoc>()
{
...
LinearIsoElasticPFDamageNoc::LinearIsoElasticPFDamageNoc(const InputParameters & parameters)
...
void
LinearIsoElasticPFDamageNoc::computeQpStress()
{
  updateVar();
  updateJacobian();
}
...
void
LinearIsoElasticPFDamageNoc::updateVar()
{
...
void
LinearIsoElasticPFDamageNoc::updateJacobian()
{
