...
template <>
InputParameters
validParams<FiniteStrainCrystalPlasticityFromEos>()
{
  InputParameters params = validParams<ComputeStressEosBase>();
...
FiniteStrainCrystalPlasticityFromEos::FiniteStrainCrystalPlasticityFromEos(const InputParameters & parameters)
  : ComputeStressEosBase(parameters),
...
void
FiniteStrainCrystalPlasticityFromEos::initQpStatefulProperties()
{
  _stress[_qp].zero();
...
void
FiniteStrainCrystalPlasticityFromEos::initSlipSysProps()
{
...
void
FiniteStrainCrystalPlasticityFromEos::assignSlipSysRes()
{
...
void
FiniteStrainCrystalPlasticityFromEos::readFileInitSlipSysRes()
{
  _gss[_qp].resize(_nss);
...
void
FiniteStrainCrystalPlasticityFromEos::getInitSlipSysRes()
{
  if (_gprops.size() <= 0)
...
void
FiniteStrainCrystalPlasticityFromEos::readFileFlowRateParams()
{
  _a0.resize(_nss);
  _xm.resize(_nss);
...
void
FiniteStrainCrystalPlasticityFromEos::getFlowRateParams()
{
...
void
FiniteStrainCrystalPlasticityFromEos::readFileHardnessParams()
{
}

// Read hardness parameters from .i file
void
FiniteStrainCrystalPlasticityFromEos::getHardnessParams()
{
  if (_hprops.size() <= 0)
...
void
FiniteStrainCrystalPlasticityFromEos::getSlipSystems()
{
...
void
FiniteStrainCrystalPlasticityFromEos::initAdditionalProps()
{
}
 ...
 */
void
FiniteStrainCrystalPlasticityFromEos::computeQpStress()
{
...
void
FiniteStrainCrystalPlasticityFromEos::preSolveQp()
{
  // Initialize variable
  if (_first_substep)
  {
...
void
FiniteStrainCrystalPlasticityFromEos::solveQp()
{
  preSolveStatevar();
  solveStatevar();
  if (_err_tol)
...
void
FiniteStrainCrystalPlasticityFromEos::postSolveQp()
{
  if (_err_tol)
  {
    _err_tol = false;
...
void
FiniteStrainCrystalPlasticityFromEos::preSolveStatevar()
{
...
void
FiniteStrainCrystalPlasticityFromEos::solveStatevar()
{
  Real gmax, gdiff;
  unsigned int iterg;
...
void
FiniteStrainCrystalPlasticityFromEos::postSolveStatevar()
{
  if (_max_substep_iter == 1) // No substepping
  {
    _gss[_qp] = _gss_tmp;
...
void
FiniteStrainCrystalPlasticityFromEos::preSolveStress()
{
  if (_max_substep_iter == 1) // No substepping
  {
...
void
FiniteStrainCrystalPlasticityFromEos::solveStress()
{
  unsigned int iter = 0;
...
void
FiniteStrainCrystalPlasticityFromEos::postSolveStress()
{
  if (_max_substep_iter == 1) // No substepping
  {
...
void
FiniteStrainCrystalPlasticityFromEos::update_slip_system_resistance()
{
  updateGss();
}
 ...
 */
void
FiniteStrainCrystalPlasticityFromEos::updateGss()
{
...
void
FiniteStrainCrystalPlasticityFromEos::calc_resid_jacob(RankTwoTensor & resid, RankFourTensor & jac)
{
  calcResidual(resid);
  if (_err_tol)
    return;
...
void
FiniteStrainCrystalPlasticityFromEos::calcResidual(RankTwoTensor & resid)
{
...
void
FiniteStrainCrystalPlasticityFromEos::calcJacobian(RankFourTensor & jac)
{
...
void
FiniteStrainCrystalPlasticityFromEos::getSlipIncrements()
{
  for (unsigned int i = 0; i < _nss; ++i)
  {
...
RankTwoTensor
FiniteStrainCrystalPlasticityFromEos::get_current_rotation(const RankTwoTensor & a)
{
  return getMatRot(a);
}
...
RankTwoTensor
FiniteStrainCrystalPlasticityFromEos::getMatRot(const RankTwoTensor & a)
{
  RankTwoTensor rot;
...
void
FiniteStrainCrystalPlasticityFromEos::computeQpElasticityTensor()
{
}

RankFourTensor
FiniteStrainCrystalPlasticityFromEos::calcTangentModuli()
{
...
void
FiniteStrainCrystalPlasticityFromEos::calc_schmid_tensor()
{
...
RankFourTensor
FiniteStrainCrystalPlasticityFromEos::elastoPlasticTangentModuli()
{
  RankFourTensor tan_mod;
...
RankFourTensor
FiniteStrainCrystalPlasticityFromEos::elasticTangentModuli()
{
  return _elasticity_tensor[_qp]; // update jacobian_mult
}

bool
FiniteStrainCrystalPlasticityFromEos::line_search_update(const Real rnorm_prev, const RankTwoTensor dpk2)
{
...
void
FiniteStrainCrystalPlasticityFromEos::internalVariableUpdateNRiteration()
{
