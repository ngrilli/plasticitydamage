...
FiniteStrainCrystalPlasticityEOSBulkViscosity::FiniteStrainCrystalPlasticityEOSBulkViscosity(const InputParameters & parameters) :
...
void
FiniteStrainCrystalPlasticityEOSBulkViscosity::calcResidual( RankTwoTensor &resid )
{
