...
InputParameters validParams<FiniteStrainCrystalPlasticityEOS>()
{
  ...
  params.addClassDescription("Crystal Plasticity base class: FCC system with power law flow rule implemented: Murnaghan equation of state");
...
FiniteStrainCrystalPlasticityEOS::FiniteStrainCrystalPlasticityEOS(const InputParameters & parameters) :
...
void
FiniteStrainCrystalPlasticityEOS::calcResidual( RankTwoTensor &resid )
{
  ...
  //pk2_new.addIa( _Bulk_Modulus_Ref * ( 1.0 - _fe.det() ) );
